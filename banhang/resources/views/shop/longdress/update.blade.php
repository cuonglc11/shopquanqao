...
<form method="post" action="">
	  <div class="form-group row">
                    ...
                    <input type="hidden" name="slco" value=" {{$product->conhang_longdress}}">
                   <input type="hidden" name="gt" value=" {{$product->picre_longdress}}">
                   <input type="hidden" name="da" value=" {{$product->daban_longdress}}">
