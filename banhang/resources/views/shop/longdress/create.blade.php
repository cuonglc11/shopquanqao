...
<form method="POST" enctype="multipart/form-data">
  <div class="form-group">
    <label for="exampleInputEmail1">Tên Áo</label>
    <input type="text" class="form-control" id="exampleInputEmail1" name="name_Ao" required>
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <label for="exampleInputEmail1">Size</label>
     <select required name="size_db" class="form-control" required>
        @foreach($size as $si)
        <option value="{{$si->id_size}}">{{$si->name_size}}</option>
            @endforeach
